        ...
        <div class="col-md-6">
            <div class="container">
                <div class="card reg-form">
                    ...
                    <form action="{{url('/SectionReg')}}" method="post" class="contact-form" enctype="multipart/form-data">

                        <h2 class="text-center"> Registration form</h2>

                        <fieldset>
                            <legend>Section Data</legend>

                            {{csrf_field()}}
                            <input type="hidden" name="ownerID" value="{{Session::get('Uid')}}">
                            <div class="input-group mb-3">
                                <input type="text" name="Name" placeholder="Name" id="name" class="form-control" onkeyup="reg_name()">

                            </div>
                            <div class="input-group mb-3">
                                <input type="text" name="Desc" placeholder="content" class="form-control" >
                            </div>
                            <div class="input-group mb-3">
