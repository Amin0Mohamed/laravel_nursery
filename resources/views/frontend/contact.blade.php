...
<section class="contact">
    <div class="container">
        <div class="row">
            <div class="col-sm-8" >
                    <div class="mapouter w-100" style="height: 740px;">
                        <div class="gmap_canvas w-100 h-auto">
                            <iframe width="100%" height="700" id="gmap_canvas" src="https://maps.google.com/maps?q=%D8%A7%D9%84%D8%B3%D8%B9%D9%88%D8%AF%D9%8A%D8%A9&t=&z=19&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://www.utilitysavingexpert.com">Utility Saving Expert</a></div><style>.mapouter{position:relative;text-align:right;height:1049px;width:1027px;}.gmap_canvas {overflow:hidden;background:none!important;height:1049px;width:1027px;}</style>
                    </div>
                <h1 class="text-center font-weight-bold"> <span class="font-italic" style="color: #008c99">tel :</span> 01013079842</h1>
              </div>
            <div class="col-sm-4" >
              <div class="card">
                <h4>Class Hours</h4>
