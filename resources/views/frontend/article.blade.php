  ...
  <div class="head-pg">
    <div class="container">
      ...
      <div class="head-right">
          ...
          <a href="#"><span> NurseryManagment@gmail.com</span></a>
   ...
   <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link link2" href="aboutus.html">abouts us</a>
          </li>
          <li class="nav-item">
            <a class="nav-link link3" href="ourstaff.html">our staffs</a>
          </li>
          <li class="nav-item">
                <a class="nav-link link4" href="services.html">services</a>
           </li>
          <li class="nav-item active">
                <a class="nav-link link5" href="blogs.html">blogs <span class="sr-only">(current)</span></a>
           </li>
          <li class="nav-item">
                <a class="nav-link link1" href="faq.html">FAQ</a>
           </li>
          <li class="nav-item ">
                <a class="nav-link link6" href="contact.html">contact us </a>
           </li>
        </ul>
...
<nav aria-label="breadcrumb">            
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Activities Improves Mind</li>
        </ol>
    </nav>
        ...
        <div class="row">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="media comm">
                            ...
                            <div class="media-body">
                                <h6><a href="" class="head-post">Amin Mohamed </a></h6>
                          ...
                          <form action="#" method="post" class="contact-form">
                            ...
                            <div class="input-group mb-3">
                              <textarea name="msg" id="" cols="90" rows="10" placeholder="Write Comment" required></textarea>
                            </div>
                            <button type="submit" class="btn btn-warning btn-sd">Add Comment <i class="fa fa-paper-plane"></i></button>
                        </form>
            ...
            <div class="col-sm-3">
              <div class="card">
                <h4>Categories</h4>
                <ul class="class-hr">
                  <li>Play School<span>( 25 )</span></li>
                  <li>Academic Perform<span>( 20 )</span></li>
                  <li>Co-curricular <span>( 22 )</span></li>
                  <li>Visual Education <span>( 15 )</span></li>
                  <li>Inter Competition <span>( 20 )</span></li>
