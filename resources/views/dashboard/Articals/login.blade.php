            ...
            <div class="col-sm-6 col-md-8 log">
                ...
                <form action="{{route('dashboard.loginadmin')}}" method="post">
                    ...
                    <div class="form-element">
                        <span><i class="fa fa-envelope"></i></span><input type="email" name="email" placeholder="أدخل الإيـميـل"/>
                    </div>
                    <div class="form-element">
                        <span><i class="fa fa-lock"></i></span><input type="password" name="password" placeholder="أدخل الرقم السري"/>
                    </div>
