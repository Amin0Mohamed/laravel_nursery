                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($users as $user)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button onclick="window.location='{{route('dashboard.users.edit',['id'=> $user->Uid])}}'" class="btn btn-info">@lang('site.edit')</button>
                                            <form action="{{route('dashboard.users.destroy',[$user->Uid])}}" method="post" style="display: inline-block">
                                                {{csrf_field()}}
                                                {{method_field('delete')}}
